...
CustomerLandingZone_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://giang-stedi-human-balance-analytics/customer/landing/"],
        "recurse": True,
    },
...
Filter_node1685801369892 = Filter.apply(
    frame=CustomerLandingZone_node1,
    f=lambda row: (not (row["shareWithResearchAsOfDate"] == 0)),
    transformation_ctx="Filter_node1685801369892",
)

# Script generated for node Customer Trusted Zone
CustomerTrustedZone_node3 = glueContext.write_dynamic_frame.from_options(
    frame=Filter_node1685801369892,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://giang-stedi-human-balance-analytics/customer/trusted/",
        "partitionKeys": [],
    },
